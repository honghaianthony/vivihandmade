...
const SEO = () => {
	return (
		<DefaultSeo
			title="Vivi Handmade UIT"
			description="Vivi Handmade UIT- Thiết kế túi xách thủ công bằng nguyên liệu sợi. Mở các lớp hướng dẫn kĩ thuật đan móc túi xách thủ công. Kinh doanh nguyên liệu và dụng cụ hỗ trợ đan móc túi xách"
			additionalMetaTags={[
				{
					name: 'viewport',
			...
			openGraph={{
				...
				site_name: 'Vivi Handmade UIT',
				description: 'Vivi Handmade UIT - Chuyên túi xách thủ công',
				images: [
					{
